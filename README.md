...
首次运行
```
wget -N https://raw.githubusercontent.com/666speed/warp-auto-reconnect/main/menu.sh && bash menu.sh [option] [lisence/url/token]
```
再次运行
```
warp [option] [lisence]
...
```
wget -N https://raw.githubusercontent.com/666speed/warp-auto-reconnect/main/menu.sh && bash menu.sh d
```
刷日本 Netflix  运行
```
warp i jp
...
首次运行
```
wget -N https://raw.githubusercontent.com/666speed/warp-auto-reconnect/main/warp-go.sh && bash warp-go.sh [option] [lisence]
```
再次运行
```bash
...
### Shell-API 运行脚本
```
wget -N https://raw.githubusercontent.com/666speed/warp-auto-reconnect/main/api.sh && bash api.sh [option]
```
  | [option] 变量  | 具体动作说明 |
  | ------------- | ------------- |
  | -h/--help     | 帮助 |
